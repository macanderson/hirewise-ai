...
SCHEMA_PATH = Path('/Users/macanderson/Workspaces/hirewise-ai/packages/database/prisma/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/macanderson/Workspaces/hirewise-ai/packages/database/prisma/schema.prisma',
        }

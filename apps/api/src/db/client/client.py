...
SCHEMA_PATH = Path('/Users/macanderson/Workspaces/hirewise-ai/packages/db/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    assessment: 'actions.AssessmentActions[models.Assessment]'
    candidate: 'actions.CandidateActions[models.Candidate]'
    interview: 'actions.InterviewActions[models.Interview]'
    ...
    def __init__(
        ...
        *,
        ...
        self.assessment = actions.AssessmentActions[models.Assessment](self, models.Assessment)
        self.candidate = actions.CandidateActions[models.Candidate](self, models.Candidate)
        self.interview = actions.InterviewActions[models.Interview](self, models.Interview)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/macanderson/Workspaces/hirewise-ai/packages/db/schema.prisma',
        }
...
class Batch:
    assessment: 'AssessmentBatchActions'
    candidate: 'CandidateBatchActions'
    interview: 'InterviewBatchActions'
    job: 'JobBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.assessment = AssessmentBatchActions(self)
        self.candidate = CandidateBatchActions(self)
        self.interview = InterviewBatchActions(self)
